...
export const KHEPREE_SURFACE_DEFINITIONS: Record<KhepreeNavSurfaceId, KhepreeSurfaceDefinition> = {
  marketing: {
    id: "marketing",
    labelVi: "Sản phẩm Khepree",
    labelEn: "Khepree Products",
    descriptionVi: "Xem công cụ Khepree và chọn phần mềm phù hợp việc bạn cần.",
    descriptionEn: "Browse Khepree tools and pick software that fits your job.",
    visibility: "PUBLIC",
    category: "core",
  ...
  account: {
    ...
    descriptionVi: "Quản lý sản phẩm, thiết bị và các nội dung bạn đã mua.",
    descriptionEn: "Manage your products, devices, and everything you purchased.",
    visibility: "PUBLIC",
    category: "platform",
  ...
  partner: {
    ...
    descriptionVi: "Dành cho người muốn giới thiệu hoặc phân phối sản phẩm Khepree.",
    descriptionEn: "For people who refer or resell Khepree products.",
    visibility: "PUBLIC",
    category: "platform",
    openBehavior: "new-tab",
  },
  download: {
    ...
    descriptionVi: "Tải bộ cài và phiên bản bạn đang được sử dụng.",
    descriptionEn: "Download installers and the versions your account can use.",
    visibility: "PUBLIC",
    category: "tools",
    openBehavior: "new-tab",
  },
  ...
  developers: {
    ...
    descriptionVi: "Hướng dẫn sử dụng và tài liệu tích hợp API.",
    descriptionEn: "Usage guides and API integration docs.",
